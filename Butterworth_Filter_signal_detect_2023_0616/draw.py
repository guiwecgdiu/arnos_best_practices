...
lin1 = pd.read_csv('baked.csv',header=None)
line2 = pd.read_csv('ori.csv',header=None)
lin3 = pd.read_csv('filter.csv',header=None)
lin4 = pd.read_csv('cancel.csv',header=None)
...
# Plot the data
plt.plot(x, lin1, label='Line 1 - Full Filtterd +-120', color='blue')
